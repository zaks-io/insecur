...
| --------------- | ---------------------------------------------------------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Public Site     | `https://insecur.cloud`, `https://www.insecur.cloud`, plus `insecur.dev` apex/www (error URIs) | `https://preview.insecur.cloud`     | `GET /`, `GET /healthz`, `GET /docs/*` (HTML plus `.md` twins), `GET /errors/*`, `GET /llms.txt`, `GET /llms-full.txt`, `GET /privacy`, `GET /security`, `GET /terms`, `GET /badges/coverage.json`, `GET /.well-known/insecur/audit-export-signing-keys.json`, `GET /.well-known/security.txt`, `GET /install.sh`, `GET /install.ps1` |
