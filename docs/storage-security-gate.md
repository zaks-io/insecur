...
- Canary Sensitive Value tests prove no plaintext reaches the enumerated surfaces via
  `pnpm test:canary` (Postgres columns and in-process console output; other surfaces pending
  sweep adapters).
