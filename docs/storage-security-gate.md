...
| Sensitive Metadata encryption   | Sensitive Metadata is encrypted under tenant-bound data keys; plaintext lookup fields are limited to Opaque Resource IDs and Display Names.                                                                        | Planned Plaintext Metadata Allowlist conformance gate ([ADR-0070](adr/0070-plaintext-metadata-allowlist-registry-and-conformance-gate.md)) for column placement, plus encryption tests for envelope correctness. The registry and conformance tests are decided but not wired yet.                                                                                                                                                |
