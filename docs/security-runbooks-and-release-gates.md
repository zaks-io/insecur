...
| Key management               | Instance root key bootstrap (generate, escrow, load — [runbooks/instance-root-key-bootstrap.md](runbooks/instance-root-key-bootstrap.md)); root key rotation; Organization Data Key rotation; Project Data Key rotation; failed or interrupted rotation job. |
