...
| Machine and provider custody | Machine identity credential compromise ([runbooks/machine-identity-credential-compromise.md](runbooks/machine-identity-credential-compromise.md)); app connection compromise or provider disconnect ([runbooks/app-connection-compromise-or-disconnect.md](runbooks/app-connection-compromise-or-disconnect.md)).                                                                                                                                                                                                                                                                                                      | `small_group_production` |
...
| Backup and recovery          | Neon Postgres restore from encrypted backup ([runbooks/neon-postgres-restore-from-encrypted-backup.md](runbooks/neon-postgres-restore-from-encrypted-backup.md)); emergency break-glass recovery without Protected Environment Secret Reveal.                                                                                                                                                                                                                                                                                                                                                                          | `small_group_production` |
| Audit and investigation      | Tamper-evident audit export and verification ([runbooks/audit-export-and-verification.md](runbooks/audit-export-and-verification.md)); suspicious audit activity investigation.                                                                                                                                                                                                                                                                                                                                                                                                                                        | `small_group_production` |
| Storage readiness            | Storage Security Gate failure response ([runbooks/storage-security-gate-failure.md](runbooks/storage-security-gate-failure.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | `small_group_production` |
| Protected change response    | Protected approval incident ([runbooks/protected-approval-incident.md](runbooks/protected-approval-incident.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `small_group_production` |
| Release gate response        | Security release gate failure ([runbooks/release-gate-failure.md](runbooks/release-gate-failure.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `production_deploy`      |
