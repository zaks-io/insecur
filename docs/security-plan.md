...
Delivery Risk Policy can deliberately allow non-protected development or preview delivery through agent-reachable channels. This is a configurable risk posture for lower-risk environments, not a shortcut around Protected Environment production approval.
...
- Delivery Risk Policy defaults secure and may relax only non-protected development or preview delivery channels.
...
- Delivery Risk Policy reviewed to prove secure defaults, explicit non-protected preview/development relaxations, and no terminal-only Protected Environment approval path.
