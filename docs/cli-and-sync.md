...
| `runtime_policy.secret_binding_environment_mismatch` | `2`  | `400`               | `-`         | Bound secret ID exists in the organization but belongs to a different Environment than the policy.                                                      |
