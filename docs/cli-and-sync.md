...
| `approval.wildcard_selection_rejected`      | `2`  | `400`               | Wildcard, tag, pattern, or all-staged promote selection is rejected (ADR-0017).                                                                         |
| `approval.promotion_change_set_immutable`   | `6`  | `409`               | Promotion Change Set is immutable after the Approval Request is created.                                                                                |
| `approval.rollback_target_not_eligible`     | `2`  | `400`               | Rollback target Published Version is not retained or not eligible for ciphertext copy.                                                                  |
