...
/** Allowlisted sensitive-metadata decrypt for Cloudflare connection validation only (ADR-0071). */
export async function decryptCloudflareConnectionBoundaryForValidation(
  keyring: Keyring,
