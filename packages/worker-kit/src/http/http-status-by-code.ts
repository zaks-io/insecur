...
export const HTTP_STATUS_BY_CODE = new Map<KnownErrorCode, number>([
  ...
  [VALIDATION_ERROR_CODES.requestBodyTooLarge, 413],
  ...
  [SECRET_ERROR_CODES.possessionMismatch, 409],
  [MIGRATE_ERROR_CODES.remoteDiverged, 409],
  [DELIVERY_POLICY_ERROR_CODES.notConfigured, 409],
  [DELIVERY_POLICY_ERROR_CODES.presetInvalid, 400],
  [DELIVERY_POLICY_ERROR_CODES.presetVersionUnsupported, 400],
  [DELIVERY_POLICY_ERROR_CODES.actorInvalid, 403],
  [DELIVERY_POLICY_ERROR_CODES.scopeInvalid, 400],
  [DELIVERY_POLICY_ERROR_CODES.previewOptInRequired, 403],
  [DELIVERY_POLICY_ERROR_CODES.previewAutomationNotAllowed, 403],
  [DELIVERY_POLICY_ERROR_CODES.protectedApprovalRequired, 403],
  [DELIVERY_POLICY_ERROR_CODES.optInEnvironmentInvalid, 400],
  [DELIVERY_POLICY_ERROR_CODES.optInNotFound, 404],
  ...
  [BACKUP_RESTORE_ERROR_CODES.notArmed, 503],
  [BACKUP_RESTORE_ERROR_CODES.targetIsLive, 503],
  [BACKUP_RESTORE_ERROR_CODES.targetNotFresh, 409],
  [BACKUP_RESTORE_ERROR_CODES.importConflict, 409],
  [BACKUP_RESTORE_ERROR_CODES.artifactNotFound, 404],
  [BACKUP_RESTORE_ERROR_CODES.artifactInvalid, 400],
  [BACKUP_RESTORE_ERROR_CODES.headerMismatch, 400],
  [BACKUP_RESTORE_ERROR_CODES.exportOperationMismatch, 409],
  ...
  [SECRET_SYNC_ERROR_CODES.notFound, 404],
  [SECRET_SYNC_ERROR_CODES.disabled, 403],
  [SECRET_SYNC_ERROR_CODES.invalidBindings, 400],
  [SECRET_SYNC_ERROR_CODES.patternBindingRejected, 400],
  [SECRET_SYNC_ERROR_CODES.secretBindingNotFound, 404],
  [SECRET_SYNC_ERROR_CODES.secretBindingEnvironmentMismatch, 400],
  [SECRET_SYNC_ERROR_CODES.invalidDestination, 400],
  [SECRET_SYNC_ERROR_CODES.resourceConflict, 409],
  [SECRET_SYNC_ERROR_CODES.displayNameInUse, 409],
  ...
  [IMPORT_ERROR_CODES.existingSecret, 409],
]);
