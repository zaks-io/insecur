...
describe("apiClientFor", () => {
  ...
  it("targets the metadata read paths with URL-encoded ids", async () => {
    ...
    await client.projectMachineIdentities("org_01JZ8E2QYQAAAAAAAAAAAAAAAA", "prj_01/../evil");
    await client.projectInjectionGrants("org_01JZ8E2QYQAAAAAAAAAAAAAAAA", "prj_01/../evil");
    ...
    expect(urls[3]).toBe(
      "https://insecur-api.internal/v1/orgs/org_01JZ8E2QYQAAAAAAAAAAAAAAAA/projects/prj_01%2F..%2Fevil/machine-identities",
    );
    expect(urls[4]).toBe(
      "https://insecur-api.internal/v1/orgs/org_01JZ8E2QYQAAAAAAAAAAAAAAAA/projects/prj_01%2F..%2Fevil/injection-grants",
    );
    expect(urls[5]).toBe(
      "https://insecur-api.internal/v1/orgs/org_01JZ8E2QYQAAAAAAAAAAAAAAAA/members",
    );
    expect(urls[6]).toBe("https://insecur-api.internal/v1/orgs/org_01%2F..%2Fevil/invitations");
    const auditUrl = new URL(urls[7] as string);
