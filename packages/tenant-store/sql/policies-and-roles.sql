-- ADR-0037 raw policy and database-role step (re-runnable). Policy predicates are byte-faithful
-- to legacy migrations; RLS ENABLE/FORCE is co-located with table DDL in the Drizzle baseline.
