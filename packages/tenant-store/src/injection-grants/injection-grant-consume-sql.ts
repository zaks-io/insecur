...
export const injectionGrantRowSelection = {
  ...
  issued_actor_type: injectionGrants.issuedActorType,
  issued_user_id: injectionGrants.issuedUserId,
  issued_machine_identity_id: injectionGrants.issuedMachineIdentityId,
  issued_runtime_policy_key_id: injectionGrants.issuedRuntimePolicyKeyId,
