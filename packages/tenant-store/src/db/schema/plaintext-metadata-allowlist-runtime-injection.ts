...
export const PLAINTEXT_METADATA_ALLOWLIST_RUNTIME_INJECTION = {
  ...
  injection_grants: {
    ...
    id: { category: "opaque-id" },
    issued_actor_type: { category: "type-code" },
    issued_machine_identity_id: { category: "opaque-id" },
    issued_runtime_policy_key_id: { category: "opaque-id" },
    issued_user_id: { category: "opaque-id" },
    org_id: { category: "opaque-id" },
    policy_id: { category: "opaque-id" },
