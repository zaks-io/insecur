...
ALTER TABLE "runtime_injection_policies" ADD CONSTRAINT "runtime_injection_policies_org_id_project_id_projects_org_id_id_fk" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "runtime_injection_policies" ADD CONSTRAINT "runtime_injection_policies_org_id_environment_id_environments_org_id_id_fk" FOREIGN KEY ("org_id","environment_id") REFERENCES "public"."environments"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "runtime_injection_policy_versions" ADD CONSTRAINT "runtime_injection_policy_versions_org_id_policy_id_runtime_injection_policies_org_id_id_fk" FOREIGN KEY ("org_id","policy_id") REFERENCES "public"."runtime_injection_policies"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
