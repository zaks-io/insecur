CREATE TABLE "machine_identity_environment_deploy_keys" (
	...
	CONSTRAINT "mi_env_deploy_keys_rot_interval_chk" CHECK ("machine_identity_environment_deploy_keys"."rotation_interval_seconds" IS NULL OR "machine_identity_environment_deploy_keys"."rotation_interval_seconds" > 0),
	CONSTRAINT "mi_env_deploy_keys_rot_reminder_chk" CHECK ("machine_identity_environment_deploy_keys"."rotation_reminder_interval_seconds" IS NULL OR "machine_identity_environment_deploy_keys"."rotation_reminder_interval_seconds" > 0)
);
--> statement-breakpoint
ALTER TABLE "machine_identity_environment_deploy_keys" ADD CONSTRAINT "mi_env_deploy_keys_org_fkey" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "machine_identity_environment_deploy_keys" ADD CONSTRAINT "machine_identity_environment_deploy_keys_org_machine_fkey" FOREIGN KEY ("org_id","machine_identity_id") REFERENCES "public"."machine_identities"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "machine_identity_environment_deploy_keys" ADD CONSTRAINT "machine_identity_environment_deploy_keys_org_project_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "machine_identity_environment_deploy_keys" ADD CONSTRAINT "machine_identity_environment_deploy_keys_org_env_fkey" FOREIGN KEY ("org_id","environment_id") REFERENCES "public"."environments"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
