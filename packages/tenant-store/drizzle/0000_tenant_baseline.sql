...
CREATE TABLE "sensitive_metadata_fields" (
	...
	"ciphertext_storage_ref" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "sensitive_metadata_fields_pkey" PRIMARY KEY("org_id","scope_project_id","metadata_type","record_resource_id","field_key"),
...
CREATE TABLE "sync_target_leases" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "sync_target_leases_pkey" PRIMARY KEY("org_id","project_id","provider_kind","target_identity"),
...
ALTER TABLE "environments" ADD CONSTRAINT "environments_org_id_project_id_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "injection_grants" ADD CONSTRAINT "injection_grants_org_id_project_id_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "injection_grants" ADD CONSTRAINT "injection_grants_org_id_environment_id_fkey" FOREIGN KEY ("org_id","environment_id") REFERENCES "public"."environments"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "machine_identity_memberships" ADD CONSTRAINT "machine_identity_memberships_org_id_machine_identity_id_fkey" FOREIGN KEY ("org_id","machine_identity_id") REFERENCES "public"."machine_identities"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "machine_identity_memberships" ADD CONSTRAINT "machine_identity_memberships_org_id_project_id_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "memberships" ADD CONSTRAINT "memberships_org_id_team_id_fkey" FOREIGN KEY ("org_id","team_id") REFERENCES "public"."teams"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "memberships" ADD CONSTRAINT "memberships_org_id_project_id_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "project_data_keys" ADD CONSTRAINT "project_data_keys_org_id_project_id_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_data_keys" ADD CONSTRAINT "project_data_keys_org_key_version_fkey" FOREIGN KEY ("org_id","organization_data_key_version") REFERENCES "public"."organization_data_keys"("org_id","key_version") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "provider_credentials" ADD CONSTRAINT "provider_credentials_org_id_app_connection_id_fkey" FOREIGN KEY ("org_id","app_connection_id") REFERENCES "public"."app_connections"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "secret_versions" ADD CONSTRAINT "secret_versions_org_id_secret_id_fkey" FOREIGN KEY ("org_id","secret_id") REFERENCES "public"."secrets"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "secrets" ADD CONSTRAINT "secrets_org_id_project_id_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "secrets" ADD CONSTRAINT "secrets_org_id_environment_id_fkey" FOREIGN KEY ("org_id","environment_id") REFERENCES "public"."environments"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "sync_target_leases_held_by_operation_id_idx" ON "sync_target_leases" USING btree ("org_id","held_by_operation_id");--> statement-breakpoint
...
DROP INDEX "invitations_one_pending_per_invitee_org_project";--> statement-breakpoint
