...
ALTER TABLE "protected_changes" ADD CONSTRAINT "protected_changes_org_project_fkey" FOREIGN KEY ("org_id","project_id") REFERENCES "public"."projects"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "protected_changes" ADD CONSTRAINT "protected_changes_org_env_fkey" FOREIGN KEY ("org_id","environment_id") REFERENCES "public"."environments"("org_id","id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "protected_change_approval_evidence" ADD CONSTRAINT "pc_approval_evidence_org_change_fkey" FOREIGN KEY ("org_id","protected_change_id") REFERENCES "public"."protected_changes"("org_id","id") ON DELETE no action ON UPDATE no action;
