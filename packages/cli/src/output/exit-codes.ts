...
const EXACT_EXIT_CODE_BY_ERROR: Partial<Record<KnownErrorCode, number>> = {
  ...
  [DELIVERY_POLICY_ERROR_CODES.notConfigured]: EXIT_ACTION_REQUIRED,
  [DELIVERY_POLICY_ERROR_CODES.presetInvalid]: EXIT_VALIDATION,
  [DELIVERY_POLICY_ERROR_CODES.presetVersionUnsupported]: EXIT_VALIDATION,
  [DELIVERY_POLICY_ERROR_CODES.actorInvalid]: EXIT_FORBIDDEN,
  [DELIVERY_POLICY_ERROR_CODES.scopeInvalid]: EXIT_VALIDATION,
  [DELIVERY_POLICY_ERROR_CODES.previewOptInRequired]: EXIT_FORBIDDEN,
  [DELIVERY_POLICY_ERROR_CODES.previewAutomationNotAllowed]: EXIT_FORBIDDEN,
  [DELIVERY_POLICY_ERROR_CODES.protectedApprovalRequired]: EXIT_FORBIDDEN,
  [DELIVERY_POLICY_ERROR_CODES.optInEnvironmentInvalid]: EXIT_VALIDATION,
  [DELIVERY_POLICY_ERROR_CODES.optInNotFound]: EXIT_NOT_FOUND,
  ...
  [BACKUP_RESTORE_ERROR_CODES.exportFailed]: EXIT_UNEXPECTED,
