 ...
 * plus e2e/canary with INSECUR_CI_RLS_GATE=1.
 */
...
console.log(
  "OK postgres-integration: INSECUR_CI_RLS_GATE will be forwarded to all workspace test:rls suites, test:e2e, and test:canary; INSECUR_TEST_SKIP_MIGRATE=1 (caller prepared the shared database)",
);
