...
- **1** (current scaffold) — CRUD + versioning + audit + GitHub OAuth + envelope encryption + scoped machine tokens + CLI `.env` pull
- **2** — Tenant-first schema, organization/project memberships, role enforcement, tenant-qualified routes, organization/project data keys
