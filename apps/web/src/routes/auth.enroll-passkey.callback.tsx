...
import { completeBrowserPasskeyEnrollment } from "../auth/browser-passkey-enrollment.js";
  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        if (!completed.ok) {
          return redirectResponse("/onboarding?passkey=failed", [formatPkceStateClearCookie()]);
        }
