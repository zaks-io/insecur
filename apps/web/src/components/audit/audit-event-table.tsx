...
import { formatAuditActorPrincipalChain } from "../../console/audit-actor.js";
import type { ConsoleAuditEvent } from "../../console/audit.js";
...
function AuditEventRow({ event }: { event: ConsoleAuditEvent }) {
  ...
  return (
    <tr className="border-t border-ink/20 align-top">
      ...
      <td className="px-4 py-3 font-mono text-xs">{formatAuditActorPrincipalChain(event)}</td>
