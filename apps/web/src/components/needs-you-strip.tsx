...
import { NeedsYouStripContent } from "./needs-you-strip-content.js";

/**
 * Home "Needs You" strip (INS-377): SSR loader seeds pending approvals; client polling refreshes
...
export function NeedsYouStrip({
  ...
  return <NeedsYouStripContent orgId={orgId} items={items} />;
}
