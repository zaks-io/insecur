...
function RejectResultPanel({ orgId, voice }: { orgId: string; voice: ApprovalActionVoice }) {
  return (
    <section
      aria-labelledby="reject-result-heading"
...
function RejectChallengeForm({
  ...
  return (
    <section aria-labelledby="reject-heading" className="rounded-xl border border-border bg-card">
      <header className="border-b border-border px-4 py-4 sm:px-5">
        <h2 id="reject-heading" className="text-2xl font-semibold tracking-tight leading-tight">
          Reject
        </h2>
